...
ERL_LIBS=.:..:../erlport-demo:$(shell $(LFETOOL) info erllibs)
OS := $(shell uname -s)
ifeq ($(OS),Linux)
        HOST=$(HOSTNAME)
endif
...
get-version:
	...
	-eval "lfe_io:format(\"~p~n\",['erlport-demo-util':'get-versions'()])." \
...
install: compile
	@echo "Installing erlport-demo ..."
	@PATH=$(SCRIPT_PATH) lfetool install lfe

upload: $(EXPM) get-version
	@echo "Preparing to upload erlport-demo ..."
	@echo
	@echo "Package file:"
	@echo
	@cat package.exs
